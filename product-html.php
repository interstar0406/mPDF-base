...
<tbody><tr>
<td style=\"border: 3.625px solid rgba(255, 255, 255, 0);\">
<div class=\"item\" data-target=\"1\" style=\"width:118.6046511627907px; height:168.6046511627907px; overflow: hidden; border: 1px solid #ef3598; background: #fff;\" data-id=\"196\">
<div class="img" style=\"width:118.6046511627907px; height:168.6046511627907px; background-image:url(\'https://mpdf-app.dev.cc:8890/img/Capture.png\'); background-size: cover; background-position: center;\">
</div>
</div>
</td>
<td style=\"border: 3.625px solid rgba(255, 255, 255, 0);\">
...
$new_output = base64_encode($new_output);

$mpdf = new \Mpdf\Mpdf();
$mpdf->Image('data:image/gif;base64,'.$new_output, 0, 0, 10, 10, 'png', '', true, false);
...
<body style="margin: 40px;">
    <h1 style="text-align: center; margin: 100px auto 50px;">This screen only works to export pdf files, check <a href="data/product.pdf" target="_blank" style="color: red">data/product.pdf</a> to see the results</h1>
